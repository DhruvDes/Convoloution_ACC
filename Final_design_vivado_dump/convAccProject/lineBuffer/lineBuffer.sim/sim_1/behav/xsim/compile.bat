...
REM
REM Generated by Vivado on Mon Apr 13 18:38:22 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj line_buffer_conv_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj line_buffer_conv_tb_vlog.prj -log xvlog.log
