...
#
# Script generated by Vivado on Sat Apr 11 14:43:17 -0400 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : loopBackFifoBD.sh
...
#
# Usage        : loopBackFifoBD.sh
#                loopBackFifoBD.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                loopBackFifoBD.sh [-rerun]
#                loopBackFifoBD.sh [-reset_run]
#                loopBackFifoBD.sh [-clean]
#                loopBackFifoBD.sh [-reset_log]
#                loopBackFifoBD.sh [-help]
#
...
# script info
echo -e "loopBackFifoBD.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./loopBackFifoBD.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L proc_sys_reset_v5_0_17 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_14 -L axi_data_fifo_v2_1_36 -L axi_register_slice_v2_1_36 -L axi_protocol_converter_v2_1_37 -L axi_clock_converter_v2_1_35 -L blk_mem_gen_v8_4_12 -L axi_dwidth_converter_v2_1_37 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot loopBackFifoBD xil_defaultlib.loopBackFifoBD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim loopBackFifoBD -key {Behavioral:sim_1:Functional:loopBackFifoBD} -tclbatch cmd.tcl -protoinst "protoinst_files/loopBackFifoBD.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb loopBackFifoBD.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./loopBackFifoBD.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: loopBackFifoBD.sh [-help]\n\
Usage: loopBackFifoBD.sh [-step]\n\
Usage: loopBackFifoBD.sh [-lib_map_path]\n\
Usage: loopBackFifoBD.sh [-rerun]\n\
Usage: loopBackFifoBD.sh [-reset_run]\n\
Usage: loopBackFifoBD.sh [-clean]\n\
Usage: loopBackFifoBD.sh [-reset_log]\n\
Usage: loopBackFifoBD.sh [-keep_index]\n\
Usage: loopBackFifoBD.sh [-noclean_files]\n\n\
