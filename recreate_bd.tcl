...
################################################################
# This is a generated script based on design: convacc
#
...
\
  ...
  # Create instance: convAcc2d_0, and set properties
  set convAcc2d_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:convAcc2d:3.0 convAcc2d_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins convAcc2d_0/s00_axis] [get_bd_intf_pins axi_dma/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net convAcc2d_0_m00_axis [get_bd_intf_pins convAcc2d_0/m00_axis] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  [get_bd_pins convAcc2d_0/axis_aclk]
  ...
  [get_bd_pins convAcc2d_0/axis_aresetn]
